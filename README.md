...
- 🔭 Graduate of the Code First Girls Degree (Data Science Stream) 
- 🌱 Skilled in Python, SQL, Pandas, NumPy, Matplotlib, with hands-on project experience
- ⚽ Building Python games, APIs, and web projects (HTML/CSS/JavaScript) in my spare time
- 🥬 Currently learning C# and JavaScript to expand my technical stack
- 🐣 Exploring game development engines (Unity, Unreal, Godot)
- 🌕 Experimenting with WearOS watch faces and Android apps in Kotlin
- 🥼 Background: Chemistry graduate with experience in accounting, now pivoting into Data Science after a family career break
- 🌻 Fun-fact (or weird flex): I once won a poetry competition about hybrid buses 🚌✨
